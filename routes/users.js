// Ce fichier doit contenir toutes les routes relatives à "user"
...
router.get('/message', (req, res) => {      /// juste pour tester la route
    console.log("Afficher des messages ici... ")
    res.end()
})
...
router.get('/user/:id', (req, res) => {
    console.log("Fecthing user with id: " + req.params.id)
    ...
    getConnection().query(queryString, [Id], (err, rows, fields) => {
        ...
        console.log("Interrogation de base des données réussie")
